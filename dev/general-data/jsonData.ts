...
interface DataRulesElement {
    text: string,
    buttons: Array<string>,
}

interface JsonDataRules {
    loisJ1: Array<DataRulesElement>,
    loisJ2: Array<DataRulesElement>,
    annonces: Array<DataRulesElement>,
    narration: Array<DataRulesElement>,
    cyborg: Array<DataRulesElement>,
    humain: Array<DataRulesElement>,

    [key: string]: Array<DataRulesElement>,
}

export default class JsonData {
    public static rulesAndButtons: JsonDataRules = {
        ...
        humain: [
            ...
            {text: "Vous devriez vous méfier de votre voisin", buttons: []}, //à ne pas dire s'il y a un cyborg à côté
        ],
